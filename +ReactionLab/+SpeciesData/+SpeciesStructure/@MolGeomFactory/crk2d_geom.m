function crk2d_geom(obj,molModelObj)
% crk2d_geom(MolGeomFactoryObj,MolecularModelObj)
%    convert crk2d file to Geom2d
...
structureNode = doc.GetElementsByTagName('Structure2D').Item(0);
...
molModelObj.Geom2d(1).bonds = bondArray;
